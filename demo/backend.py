...
def extract_table_mentions_from_text(
    ...
    COMMON_WORDS = {
        ...
        "enrolled_school_month_heatmap",
        "enrolled_month_dist",
        "no_payment_due_summary",
        "no_payment_due_bool_dist",
        "longest_absense_summary",
        "longest_absense_month_dist",
        "enlist_summary",
        "enlist_organ_dist",
        "disabled_summary",
        "disabled_dist",
